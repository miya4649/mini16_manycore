set rtl_files {top.v topinclude.v ../cdc_synchronizer.v ../default_master_code_mem.v ../default_master_data_mem.v ../default_pe_code_mem.v ../default_pe_data_mem.v ../fifo.v ../harvester.v ../mini16_cpu.v ../mini16_pe.v ../mini16_soc.v ../r2w1_port_ram.v ../rw_port_ram.v ../shift_register.v ../uart.v ../uart_io.v}
